  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.z-2.mb-4.mb-lg-5
      .col-md-10.col-lg-12.col-xl-10
        ...
        figcaption <strong>Fuente:</strong> Tomado y adaptado de <em>trámites y servicios de la VUCE</em>, Ventanilla Única de Comercio Exterior. https://www.vuce.gov.co/vuce/tramites-y-servicios-de-la-vuce.
